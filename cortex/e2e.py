...
Usage::
    ...
    python -m cortex.e2e --conversation tests/fixtures/generated/short_001.json

    # Offline verification of the harness (no backend / no model needed):
    python -m cortex.e2e --conversation tests/fixtures/generated/short_001.json --mock
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--conversation", default="tests/fixtures/generated/short_001.json")
