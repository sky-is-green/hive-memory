...
| Retrieval recall | n/a (FIFO) | ≥75% / ≥90% | **90.3%** live (deterministic P2, run 211131); **75.7%** on the full 20-conv evidence run (`20260823_014521`, ingestion_rate 54.3%, perfect-hive ceiling 45.1% — honest stated-facts); **93.5%** honest stated-facts (live3); ingestion-bound (`ingestion_rate` 48.4% / 33.9%) |
